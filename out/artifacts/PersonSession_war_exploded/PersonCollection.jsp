...
<form action="PersonCollection.jsp">
    ...
    <div class="row">
        <div class="form-group col-sm">
            ...
            <div class="form-group form-inline" id="height-add">
                <label for="feet-height-add" class="sr-only">ft</label>
                <input type="number" class=form-control placeholder="ft" name="heightFt" id="feet-height-add">
                <label for="inch-height-add" class="sr-only">cm</label>
                <input type="number" class="form-control ml-2" placeholder="cm" name="heightInch" id="inch-height-add">
            </div>
        </div>
        <div class="form-group col-sm">
    ...
    <c:forEach items="${sessionScope.personCollect}" var="person">
        <tr>
            <form action="PersonCollection.jsp">
                ...
                <td>
                    <input type="number" class=form-control placeholder="ft" name="heightFt" value="${person.height.feet}">
                </td>
                <td>
                    <input type="number" class="form-control ml-2" placeholder="cm" name="heightInch" value="${person.height.inch}">
                </td>
